...
def build_parser() -> argparse.ArgumentParser:
    ...
    validate_parser = subparsers.add_parser("validate", help="Validate .env vs .env.example")
    ...
    docs_parser = subparsers.add_parser("docs", help="Generate docs/config.md from .env.example")
